					...
					<Box className="w-full sm:w-2/3 md:w-2/4 xl:w-1/4" mt={30}>
						<form className="w-full" onSubmit={handleFormSubmit}>
							...
							<Flex align="center" gap={6}>
								<Input type={showKey ? "text" : "password"} value={signingKey} bg="dark.8" px={14} py={8} variant="unstyled" onChange={(e) => setSigningKey(e.currentTarget.value)} className="w-full placeholder-neutral-700 rounded-lg" />
							...
							<Button type="submit" variant="filled" size="lg" radius="md" bg="brand" className="bg-rose-600 text-sm w-full">
								Create Session
							</Button>
						</form>
					</Box>
